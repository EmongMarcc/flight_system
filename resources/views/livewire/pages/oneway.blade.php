    ...
    <div class="p-2">
          <div class="bg-white border border-gray-300 gap-6 grid grid-cols-1 p-6 rounded-lg shadow-lg">
            <div class="gap-1 grid grid-cols-2">
              <a href="{{url('/onewaytickets')}}" class="w-full px-4 py-2 font-bold text-white bg-blue-500 rounded-full duration-300 hover:bg-blue-700 focus:outline-none focus:shadow-outline text-center">One way Ticket List</a>
              <a href="{{url('/')}}" class="w-full px-4 py-2 font-bold text-white bg-blue-500 rounded-full duration-300 hover:bg-blue-700 focus:outline-none focus:shadow-outline text-center">Round Trip</a>
            </div>
            <div class="font-mono">
		<!-- Container -->
		<div>
			<div class="flex justify-center">
              ...
              <div class="mb-1 md:flex md:justify-between">
                <div class="mb-1 md:mr-2 md:mb-0 w-full">
                  <input type="text"  style="<?php if ($from): ?>border-color: green;<?php else: ?>  border-color: crimson;  <?php endif; ?>" wire:model="from" placeholder="ICAO Airport Code" class="w-full border-2 px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" />
                </div>
                <div class="md:ml-2 w-full ">
                  <input type="text"  style="<?php if ($to): ?>border-color: green;<?php else: ?>  border-color: crimson;  <?php endif; ?>" wire:model="to" placeholder="ICAO Airport Code" class="w-full border-2 px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" />
                </div>
              </div>
